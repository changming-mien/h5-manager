        ...
        <aside :class="asideClassName">
            ...
            <div class="logo-c">
				<div>
					...
					<P v-show="isShowAsideTitle">
						<span>中国银行</span>
					</P>
				</div>
            </div>
		    <P v-show="isShowAsideTitle" class = "logo-last">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</P>
            <!-- 菜单栏 -->
...
export default {
    ...
    mounted() {
        ...
        console.log(this.getMenus(name))
        this.$nextTick(() => {
    ...
    methods: {
        ...
        gotoPage(name, params) {
            ...
            if(locurl[locurl.length-1] != name){
...
.ivu-menu-dark.ivu-menu-vertical .ivu-menu-opened .ivu-menu-submenu-title {
	background: #52a3f5 !important;
}
.ivu-menu-dark.ivu-menu-vertical .ivu-menu-submenu .ivu-menu-item-active, .ivu-menu-dark.ivu-menu-vertical .ivu-menu-submenu .ivu-menu-item-active:hover {
		background-color:#52a3f5 !important;
}
.ul-c .active {
